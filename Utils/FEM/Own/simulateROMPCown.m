function [DATA] = simulateROMPCown(FOM, ROM, CTRL, ROM_CTRL, Zbar, T, X0, opt)
...
%         xbar
    ...
    elseif strcmp(ctrl_type, 'rompc')
        if ~continuous || (continuous && i == update)
            ...
            [xopt, uopt, solver] = solveOptimalControlOwn(ROM_CTRL, xbar, uin, opt);
...
%             if t == 10
%                 wf = wfLB + 10*rand(mw,1).*(wfUB - wfLB);
%             end
